...
@FeignClient(name= "aiModel", url = "http://192.168.0.14:8000")
public interface ModelFeign {
    ...
    @PostMapping(value = "/api/rtp/")
    ResponseEntity<ResumeToPostingDTO> resumeToJobPosting(@RequestParam("urlPath") String urlPath);
}
